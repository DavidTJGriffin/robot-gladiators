...
var fight = function (enemyName) { // repeat and execute as long as the enemy-robot is alive
    while (enemyHealth > 0) {
        ...
        } else if (promptFight === "skip" || promptFight === "SKIP") { // confirm player wants to skip
